...
local Window = Library:Create("4x4","Made by ogdev")
local Tab1 = Window:Tab("Aimlocks",true)
 
Tab1:Label("Aimlock")
 
Tab1:Button("Activate",function(bool)
...
Tab1:Textbox("Aimlock Keybind","T",function(bool)
    getgenv().AimlockKey = bool
end)
 
Tab1:Textbox("Prediction","0.1429",function(bool)
...
Tab3:Slider("Fov Changer",80,200,function(text)
    workspace.CurrentCamera.FieldOfView = (text)
end)
 
Tab3:Button("Serverside Anims",function(bool)
    while true do
        wait(1)
...
Tab3:Button("Clientside Headless",function(bool)
...
Tab3:Button("Clientside Korblox",function(bool)
...
local garbage = {
    ...
    "waste of life";
    "sit son";
    "hop back on fortnite";
    "real life geek";
    "are you aiming with your feet";
...
Tab4:Button("Activate Aimlock",function(bool)
...
Tab5:Button("Tac Shotgun",function(value)
    getgenv().game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(470.877533, 45.1272316, -620.630676, 0.999999821, 0.000604254019, -2.6080214e-8, -0.000604254019, 0.999999821, -0.000086322005, -2.6080214e-8, 0.000086322005, 1)
end)
 
Tab5:Button("RPG",function(value)
    getgenv().game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(113.668922, -26.7500324, -267.85083, 0.998740435, 2.78358e-8, 0.0501755178, -2.3086992e-8, 1, -9.522349e-8, -0.0501755178, 9.394515e-8, 0.998740435)
end)
 
Tab5:Button("Armor",function(value)
    getgenv().game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-933.937195, -25.2498283, 570.559143, -0.999964893, 1.361646e-8, -0.00838218257, 1.3722526e-8, 1, -1.2596267e-8, 0.00838218257, -1.2710849e-8, -0.999964893)
end)
 
Tab5:Button("LMG",function(value)
    getgenv().game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-620.786011, 23.2457371, -305.320648, 0.997471213, -1.7573178e-8, 0.0710718185, 1.8362883e-8, 1, -1.0457973e-8, -0.0710718185, 1.1736611e-8, 0.997471213)
end)
 
Tab5:Button("Bank",function(value)
    getgenv().game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-433.219788, 38.9678497, -284.153748, 0.0627829283, -1.8860232e-8, -0.998027205, -2.408735e-8, 1, -2.0412775e-8, 0.998027205, 2.5321405e-8, 0.0627829283)
end)
  
Tab5:Button("SafeMeet",function(value)
    getgenv().game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-119.108002, -58.7000732, 146.870834, 0.0627521127, 9.1778665e-9, -0.998029172, -1.3202886e-8, 1, 8.365845e-9, 0.998029172, 1.265189e-8, 0.0627521127)
end)
...
Tab7:Label("Made by OG dc: ogn5")
Tab7:Label("Alex -Helped with UI and Key")
Tab7:Label("discord.gg/VqNrjraDxD")
